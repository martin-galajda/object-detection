...
class BoxableImagesConstants:
    ...
    BOXABLE_PLACEHOLDER_PATH = f'{Constants.RESOURCES_PATH}/placeholders/placeholder_img_boxable.npy'
    ...
    PATH_TO_BOXABLE_LABELS_DESCRIPTIONS_CSV = f'{Constants.METADATA_FILES_DIR_PATH}/boxable/class-descriptions-boxable.csv'

    YOLOV2_MODEL_NAME = 'yolov2'
