...
DB_PATH = OpenImagesConstants.IMAGES_DB_PATH

TRAIN_TABLE_NAME = OpenImagesConstants.TRAIN_TABLE_NAME_IMAGES
VALIDATION_TABLE_NAME = OpenImagesConstants.VALIDATION_TABLE_NAME_IMAGES

DEFAULT_PATH_TO_TRAIN_IMAGES_CSV = f'{OpenImagesConstants.METADATA_FILES_DIR_PATH}/train-images-with-labels-with-rotation.csv'
DEFAULT_PATH_TO_VALIDATION_IMAGES_CSV = f'{OpenImagesConstants.METADATA_FILES_DIR_PATH}/validation-images-with-rotation.csv'
